...
from truce_adjudicator.panel.agentic_research import AgenticResearcher, SharedEvidencePool
...
class TestAgenticResearcher:
    ...
    @pytest.mark.asyncio 
    async def test_research_turn_execution(self, researcher, sample_claim, mock_search_result):
